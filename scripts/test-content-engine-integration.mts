...
function testLegacyEntrypointsUseFacade() {
  ...
  assertIncludes(bulkRoute, "import { generateContentDirect } from '@/lib/amc-content/contentGenerationService'", 'bulk route content facade import')
  assertIncludes(bulkRoute, 'const cwResult = await generateContentDirect({', 'bulk route content facade call')
