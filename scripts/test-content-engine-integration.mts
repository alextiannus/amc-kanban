...
function testViralCopyScriptBridge() {
  ...
  assertIncludes(postEditDrawer, 'const shouldUseBatchGeneration = targetAccountIds.length > 1', 'multi-copywriter modal chooses batch generation by user intent')
  assertIncludes(postEditDrawer, 'if (shouldUseBatchGeneration)', 'multi-copywriter modal must not fan out trigger-copywriter requests')
