...
const profile = { id: 'voice-a', brandId: 'brand-a', providerVoiceId: 'clone-a', configId: 'config-a',
  configFingerprint: createHash('sha256').update('test-key-a|https://api.minimaxi.com/').digest('hex'), activatedAt: '2026-09-09',
  label: 'Owner', role: 'owner', status: 'ready',
