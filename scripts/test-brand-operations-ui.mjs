...
(async () => {
 ...
 try {
  ...
  role='AMC_PRINCIPAL';await page.reload();await page.getByRole('cell',{name:/测试餐饮品牌.*新加坡/}).waitFor();assert.equal(await page.getByRole('button',{name:'更换主理人：测试餐饮品牌'}).count(),0);
