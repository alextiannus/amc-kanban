...
assert(brandPlanService.includes('contentIdea: item.planning'))
assert(brandPlanService.includes('sanitizeCalendarRewritePlanning('))
assert(!brandPlanService.includes('reviewCalendarCreativeItemsWithLLM'))
