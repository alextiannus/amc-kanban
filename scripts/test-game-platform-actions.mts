...
assert.match(client, /body: JSON\.stringify\(\{ brandId, sessionId, platform, draftId: shareDraftId \}\)/)
assert.match(client, /disabled=\{!draft\.trim\(\) \|\| Boolean\(rewardingPlatform\)\}/)
