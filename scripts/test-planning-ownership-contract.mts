...
const [sso, sidebar, permissions, brandProfile, brandPlanRoute, brandPlanService, subscriptionRoute, schema, planning, contentContext, migration] = await Promise.all([
