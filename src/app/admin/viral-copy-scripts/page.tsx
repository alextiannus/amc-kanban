...
export default async function ViralCopyScriptsEntryPage() {
  ...
  if (contentUrl && secret) {
    ...
    redirect(`${contentUrl}/admin/viral-copy-scripts#labToken=${encodeURIComponent(token)}`)
  }

  return (
    <main className="min-h-screen bg-slate-50 px-6 py-10 text-slate-950">
      <div className="mx-auto max-w-2xl rounded-md border border-slate-200 bg-white p-6">
        <h1 className="text-xl font-semibold">爆品脚本由 amc-content 提供</h1>
