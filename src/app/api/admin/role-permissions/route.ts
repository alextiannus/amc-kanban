...
export async function GET() {
  ...
  try { return Response.json({ ...await readPolicies(), modules: PERMISSION_MODULES, protocolVersion: PERMISSION_PROTOCOL, contentReady: await contentPolicyReady() }, { headers: { 'Cache-Control': 'no-store' } }) }
