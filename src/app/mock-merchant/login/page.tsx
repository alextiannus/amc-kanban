...
const LABEL_CLASS = 'block font-mono text-xs text-slate-500 mb-2 ml-1 uppercase tracking-wider'
const INPUT_CLASS = 'w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 pl-11 pr-12 text-slate-800 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/50 transition-all placeholder:text-slate-400 text-sm shadow-sm'
...
export default function MockMerchantLogin() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center bg-[#F8FAFC] overflow-hidden text-slate-800 p-4 md:p-8">
      ...
      {/* Main Container */}
      <main className="relative z-10 w-full max-w-[440px] bg-white/80 border border-slate-200/80 rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/60 backdrop-blur-md p-8 md:p-10 flex flex-col">
        {/* Header */}
