...
export const ROLE_LABELS: Record<AppRole, string> = { ADMIN: '管理员', AMC_PRINCIPAL: '主理人', BRAND_OWNER: '品牌主', BD: 'BD', RESEARCHER: '研究员' }
...
export type Context = { roles: AppRole[]; menuRoles?: AppRole[]; accountRoles?: AppRole[]; active?: boolean; brandScope?: BrandScope }
