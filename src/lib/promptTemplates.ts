...
export const DEFAULT_PROMPT_TEMPLATES = [
  ...
  },
  {
    ...
    template: [
      ...
      '如果输入提供 productCatalog 或 menuItems，必须优先使用具体 SKU/套餐/服务，而不是泛写“招牌产品”；优先选择同时命中热销、高复购、商家主推、招牌或套餐标签的项目。',
      '如果 productCatalog、门店资料或输入明确提供价格、适合人数、套餐内容或搭配建议，可以写成价格感知和点单判断，例如“$200 够几个人吃”“$30 一个人能点到什么”；没有明确价格时不要编，也不要因此否掉创意。',
      '如果当前创意需要价格判断但缺少明确价格，把“主理人确认/补充价格”写入 materialRequirements，让主理人 review 时补充。',
      '除非输入明确提供价格、活动和有效条件，否则不要写价格、优惠、赠品、暗号、隐藏福利、出示本条、套餐价公开；可以写“菜单/活动规则需门店确认”。',
      '新加坡餐饮内容里，如果品牌资料、门店资料或素材明确提到 no service charge、no GST、不收服务费、不收 GST，可以作为本地顾客决策卖点；没有资料确认时不要编造。',
      '不要写天花板、必吃、爆单、刷屏、引爆、全网这类夸张词。语气要像门店运营给拍摄团队的 brief，不像 AI 总结。',
