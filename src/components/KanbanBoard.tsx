      ...
      <div className="relative flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800">
        ...
        <div className="flex-1 flex justify-end w-full lg:w-auto items-center gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/20 dark:hover:bg-indigo-900/40 text-indigo-700 dark:text-indigo-400 px-3 py-2 rounded-xl transition-all duration-300 border border-indigo-100 dark:border-indigo-800/50"
          >
            <Bot size={15} />
            <span className="text-xs font-bold hidden lg:inline">{generatingKey ? '生成中...' : '生成新 Agent 密锥'}</span>
          </button>
          <button
            onClick={() => handleCopy()}
            className="flex items-center justify-center gap-2 bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-900/20 dark:hover:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-2 rounded-xl transition-all duration-300 border border-emerald-100 dark:border-emerald-800/50"
          >
            <span className="text-xs font-bold hidden lg:inline">复制初始化 Skill</span>
