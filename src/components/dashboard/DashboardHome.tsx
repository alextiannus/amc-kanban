...
const ALL_PLATFORMS = [
  ...
  { id: 'threads',     name: 'Threads',     icon: 'https://cdn.simpleicons.org/threads/000000',       metric: '粉丝',   unit: '', iconDark: 'https://cdn.simpleicons.org/threads/ffffff' },
  { id: 'bluesky',     name: 'Bluesky',     icon: 'https://cdn.simpleicons.org/bluesky/1185F0',       metric: '粉丝',   unit: '' },
  { id: 'telegram',    name: 'Telegram',    icon: 'https://cdn.simpleicons.org/telegram/26A5E4',      metric: '订阅',   unit: '' },
