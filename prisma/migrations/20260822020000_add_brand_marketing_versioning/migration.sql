...
INSERT INTO "SubscriptionOperationsStrategy" (
  ...
  (
    ...
    'essential',
    'Booster · 增长战役版',
    '["每月至少 24 次图文 + 12 条精品视频","Instagram 品牌经营","TikTok 爆点内容","小红书中文搜索型生活方式笔记","Google Map 口碑和转化承接","定制月度增长策划案","专业素材采集","10 位博主分批探店","每周舆情与运营复盘"]'::jsonb,
    '["instagram","tiktok","xiaohongshu","google_business"]'::jsonb,
    36,
    '{"platforms":{"instagram":{"postsPerWeek":3},"tiktok":{"postsPerWeek":3},"xiaohongshu":{"postsPerWeek":2},"google_business":{"postsPerWeek":1}}}'::jsonb,
    1,
    '{"positioning":"增长战役 + 素材资产 + 博主扩散","promise":"用一个月把品牌内容、活动话题、博主探店和地图口碑一起推起来，让更多人看到、收藏、咨询、到店。","platformRoles":{"instagram":"从门面展示升级为品牌经营，覆盖招牌菜故事、套餐组合、活动海报、顾客场景、Reels、Story 互动。","tiktok":"主攻爆点内容，围绕价格锚点、反差卖点、制作过程、挑战话题、限时活动、探店视频连续发布。","xiaohongshu":"面向中文用户、中国游客、留学生和华语本地消费者，做可搜索、可收藏、可照着去的中文生活方式笔记。","google_business":"强化评论回复、差评修复、照片更新、菜单和热门产品呈现，把社媒种草流量接住。"},"contentMix":["24 次图文","12 条精品视频","4 个内容主题周"],"creatorPlan":["6 位 2k+","3 位 4k+","1 位 1w+","分批发布，避免同一天刷屏"],"reporting":"每周舆情报告：曝光、互动、评论、收藏、私信、Google 评分、热门内容、下周调整动作。","bestFor":["新店开业或新菜单上线","节日档期推广","评分低或评论少的口碑修复","吸引游客和中文用户","商圈竞争强"],"constraints":["按月策划活动","内容产出需覆盖图文与短视频","重点看收藏、搜索、评论咨询和到店转化"]}'::jsonb
  ),
  (
